        ...
        <div className={styles.left}>
          <div className={styles.form}>
            ...
            <form>
              ...
              <input type="email" placeholder="Correo" name=""></input>
              <input type="text" placeholder="Asunto" name=""></input>
              <textarea placeholder="Mensaje" name=""></textarea>
          ...
          <div className={styles.info}>
            <div className={styles.text}>
              ...
              <p>
                Calle Séptima y Media 3214, Santa Rosa,<br></br>31050 Chihuahua, Chih.
